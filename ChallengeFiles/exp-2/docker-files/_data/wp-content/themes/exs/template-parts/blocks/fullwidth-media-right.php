...
<div class="wp-block-group <?php echo esc_attr( $args['className'] ); ?>"><div class="wp-block-group__inner-container"><!-- wp:media-text {"align":"full","mediaPosition":"right","mediaId":405,"mediaType":"image","imageFill":true} -->
		<div class="wp-block-media-text alignfull has-media-on-the-right is-stacked-on-mobile is-image-fill"><figure class="wp-block-media-text__media" style="background-image:url(<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/cup.jpg);background-position:50% 50%"><img src="<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/cup.jpg" alt="" class="wp-image-405 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:spacer {"className":"hidden-md","hidden":"hidden-md"} -->
				...
				<div class="wp-block-columns cols-single-lg"><!-- wp:column {"className":""} -->
					<div class="wp-block-column"><!-- wp:list {"className":"mb-2 styled","mb":"mb-2","styled":true} -->
						<ul class="mb-2 styled"><li>Ullamcorper ultricies</li><li>Vitae dictum enim</li><li>Enim vestibulum</li></ul>
						<!-- /wp:list --></div>
					<!-- /wp:column -->
				...
				<div class="wp-block-buttons mb-3"><!-- wp:button {"className":""} -->
					...
					<div class="wp-block-button"><a class="wp-block-button__link has-main-background-color has-background" href="#">Vitae
							Donec</a></div>
					<!-- /wp:button --></div>
				<!-- /wp:buttons -->
