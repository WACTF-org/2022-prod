...
function eme_add_options($reset=0) {
   ...
   $eme_options = array('eme_event_list_item_format' => '<li>#_STARTDATE - #_STARTTIME<br /> #_LINKEDNAME<br />#_TOWN </li>',
   ...
   'eme_task_signup_cancelled_ok_html' => $task_signup_cancelled_ok_html_localizable,
   ...
   'eme_form_required_field_string' => $eme_rsvp_required_field_localizable,
   ...
   'eme_payconiq_button_img_url' => $eme_plugin_url."images/payment_gateways/payconiq/logo.png",
...
function eme_options_register() {
   ...
   switch ( $tab ){
	      ...
	      case 'rsvp' :
	         ...
	         break;
	      case 'tasks' :
                 $options = array ('eme_task_registered_users_only','eme_task_allow_overlap','eme_task_form_format','eme_task_signup_format','eme_task_signup_recorded_ok_html','eme_task_signup_cancelled_ok_html','eme_task_reminder_days');
	         break;
	      case 'mail' :
                 $options = array ('eme_rsvp_mail_notify_is_active','eme_rsvp_mail_notify_pending','eme_rsvp_mail_notify_paid','eme_rsvp_mail_notify_approved','eme_mail_sender_name','eme_mail_sender_address','eme_rsvp_mail_send_method','eme_smtp_host','eme_smtp_port','eme_smtp_encryption','eme_rsvp_mail_SMTPAuth','eme_smtp_username','eme_smtp_password', 'eme_smtp_debug','eme_rsvp_send_html','eme_mail_bcc_address','eme_smtp_verify_cert','eme_queue_mails','eme_cron_send_queued','eme_cron_queue_count','eme_people_newsletter','eme_people_massmail','eme_massmail_popup_text','eme_massmail_popup','eme_mail_tracking');
	         break;
	      case 'mailtemplates' :
	      ...
	      case 'maps' :
	         ...
	         break;
	      case 'other' :
                 $options = array ('eme_thumbnail_size','eme_image_max_width','eme_image_max_height','eme_image_max_size','eme_html_header','eme_html_footer','eme_event_html_headers_format','eme_location_html_headers_format','eme_csv_separator','eme_use_external_url','eme_bd_email','eme_bd_email_members_only','eme_time_remove_leading_zeros','eme_stay_on_edit_page','eme_localize_price','eme_decimals','eme_timepicker_minutesstep','eme_form_required_field_string','eme_allowed_html','eme_allowed_style_attr','eme_version','eme_pdf_font','eme_backend_dateformat','eme_backend_timeformat','eme_unique_email_per_person');
	         break;
   }
...
?>
	...
	if ($conflict_found === true) {
		_e('The EME SEO permalink settings are conflicting with itself (the permalink prefix setting for either events, locations or categories contains a value that is not unique). Please resolve the conflict by changing your EME SEO permalink settings.','events-made-easy');
	} else {
		_e('The EME SEO permalink settings are conflicting with an existing page (the permalink setting for either events, locations or categories is identical with the permalink of another wordpress page). This might cause problems rendering either events or that page. Please resolve the conflict by either changing your EME SEO permalink settings or the permalink of the conflicting page.','events-made-easy');
		echo "<br />";
...
<table class="form-table">
   ...
   eme_options_select ( __('Autocomplete sources','events-made-easy'), 'eme_autocomplete_sources', array ('none'=>__('None','events-made-easy'), 'people' => __('EME people','events-made-easy'), 'wp_users' => __( 'Wordpress users', 'events-made-easy'), 'both' => __('Both EME people and WP users','events-made-easy')), __('Decide if autocompletion is used in rsvp or membership forms and select if you want to search EME people, WP users or both. The autocompletion only works on the lastname field and only if you have sufficient rights (event creator or event author).','events-made-easy') );
...
<h3><?php _e ( 'Events', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Locations', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Categories', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Holidays', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Templates', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Discounts', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'People and groups', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Memberships', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Bookings', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Mails', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Custom fields', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Attendances', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Actions', 'events-made-easy'); ?></h3>
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Settings', 'events-made-easy'); ?></h3> 
<div>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'Membership options', 'events-made-easy'); ?></h3>
<table class="form-table">
   <?php
...
<h3><?php _e ( 'RSVP: form formats', 'events-made-easy'); ?></h3>
<table class='form-table'>
   <?php
...
<?php
	      ...
	      case 'tasks' :
?>
<h3><?php _e ( 'Event tasks options', 'events-made-easy'); ?></h3>
<table class='form-table'>
   <?php
...
<table class='form-table'>
   <?php
   eme_options_radio_binary ( __( 'Enable the RSVP e-mail notifications?', 'events-made-easy'), 'eme_rsvp_mail_notify_is_active', __( 'Check this option if you want to receive an email when someone books seats for your events.', 'events-made-easy') );
   ?>
</table>
<table id="rsvp_mail_notify-data" class='form-table'>
   <?php
   eme_options_radio_binary ( __( 'Enable pending RSVP e-mails?', 'events-made-easy'), 'eme_rsvp_mail_notify_pending', __( 'Check this option if you want to send mails for pending bookings.', 'events-made-easy') );
   eme_options_radio_binary ( __( 'Enable approved RSVP e-mails?', 'events-made-easy'), 'eme_rsvp_mail_notify_approved', __( 'Check this option if you want to send mails for approved bookings.', 'events-made-easy') );
...
<table class='form-table'>
   ...
   <tr style='vertical-align:top' id='eme_queued_mails_options_row'>
      <th scope="row"><?php _e('Mail queue settings', 'events-made-easy') ?></th>
      <td>
   ...
   eme_options_input_text ( __( 'Default email sender name', 'events-made-easy'), 'eme_mail_sender_name', __( "The default name on e-mails when EME sends mails. If left empty, the name of the blog admin will be used for generic mails, while for events and memberships the configured contact person will be used. It is recommended to leave this empty.", 'events-made-easy') );
   eme_options_input_text ( __( 'Default email sender address', 'events-made-easy'), 'eme_mail_sender_address', __( "The default email address with which EME mails will be sent. If left empty, the name of the blog admin will be used for generic mails, while for events and memberships the configured contact person will be used. It is recommended to leave this empty. If you use Gmail to send mails, this must correspond with your Gmail account.", 'events-made-easy'), "email" );
   ...
   eme_options_select ( __( 'Mail sending method', 'events-made-easy'), 'eme_rsvp_mail_send_method', array ('smtp' => 'SMTP', 'mail' => __( 'PHP mail function', 'events-made-easy'), 'sendmail' => 'Sendmail', 'qmail' => 'Qmail', 'wp_mail' => 'Wordpress Mail (default)' ), __( 'Select how you want to send out emails.', 'events-made-easy') );
   ...
   echo "<tr><th colspan='2'>".sprintf(__("Hint: after you changed your mail settings, go to the <a href='%s'>Emails management</a> submenu to send a test mail.",'events-made-easy'),$test_url).'</td></tr>';
   ?>
</table>
<?php
	      break;
...
<h3><?php _e ( 'Full name format', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
<h3><?php _e ( 'Booking Made or Approved Email', 'events-made-easy'); ?></h3>
<div>
<?php
...
?> 
	<tr><th scope='row'><?php _e('Booking made mail attachments', 'events-made-easy');?></th>
<td>
...
<h3><?php _e ( 'Booking Pending Email', 'events-made-easy'); ?></h3>
<div>
<?php
		      if (!get_option('eme_rsvp_mail_notify_is_active')) {
			      print "<div class='info eme-message-admin'><p>".__('RSVP notifications are not activated, so these mails will not be sent. Go in the Mail settings to activate this if wanted.','events-made-easy')."</p></div>";
...
?> 
	<tr><th scope='row'><?php _e('Pending mail attachments', 'events-made-easy');?></th>
<td>
...
<h3><?php _e ( 'Booking Updated Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
      if (!get_option('eme_rsvp_mail_notify_is_active')) {
...
<h3><?php _e ( 'Booking Reminder Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
      if (!get_option('eme_rsvp_mail_notify_is_active')) {
...
<h3><?php _e ( 'Booking Cancelled Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
      if (!get_option('eme_rsvp_mail_notify_is_active')) {
...
<h3><?php _e ( 'Booking Deleted Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
      if (!get_option('eme_rsvp_mail_notify_is_active')) {
...
<h3><?php _e ( 'Booking Paid Email', 'events-made-easy'); ?></h3>
<div>
<?php
      if (!get_option('eme_rsvp_mail_notify_is_active')) {
	      print "<div class='info eme-message-admin'><p>".__('RSVP notifications are not activated, so these mails will not be sent. Go in the Mail settings to activate this if wanted.','events-made-easy')."</p></div>";
...
?>
        <tr><th scope='row'><?php _e('Booking paid mail attachments', 'events-made-easy');?></th>
<td>
...
<h3><?php _e ( 'Booking Payment Gateway Notification Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
      if (!get_option('eme_rsvp_mail_notify_is_active')) {
...
<h3><?php _e ( 'Mailing group subscription Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
...
?>
	<tr><th scope='row'><?php _e('Subscribe mail attachments', 'events-made-easy');?></th>
<td>
<span id="subscribe_attach_links"><?php
...
<input type="button" name="subscribe_attach_button" id="subscribe_attach_button" value="<?php _e('Add attachments', 'events-made-easy');?>" class="button-secondary action">
<input type="button" name="subscribe_remove_attach_button" id="subscribe_remove_attach_button" value="<?php _e('Remove attachments', 'events-made-easy');?>" class="button-secondary action">
<br /><?php _e('Optionally add attachments to the mail when someone subscribes to a mailing group.','events-made-easy');?>
</td></tr>
<?php
...
<h3><?php _e ( 'Task Signup Made Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
<h3><?php _e ( 'Task Signup Reminder Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
...
<h3><?php _e ( 'Task Signup Cancelled Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
...
<h3><?php _e ( 'Task Signup Deleted Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
...
<h3><?php _e ( 'Birthday Email', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
<?php
...
<?php print __('For more info concerning GDPR, see', 'events-made-easy')." <a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/6-shortcodes/eme_gdpr_approve/'>".sprintf(__('the documentation about the shortcode %s', 'events-made-easy'),'eme_gdpr_approve')."</a>, <a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/6-shortcodes/eme_request_personal_info/'>".sprintf(__('the documentation about the shortcode %s', 'events-made-easy'),'eme_request_personal_info').'</a> '.__('and','events-made-easy')." <a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/6-shortcodes/eme_change_personal_info/'>".sprintf(__('the documentation about the shortcode %s', 'events-made-easy'),'eme_change_personal_info')."</a>"; ?>
<table class='form-table'>
   <?php
   if (get_option('eme_rsvp_send_html') == '1') {
      $use_html_editor=1;
...
<h3><?php _e ( 'Offline payment info', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
<h3><?php _e ( 'Paypal', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
      ...
      eme_options_select ( __('PayPal live or test','events-made-easy'), 'eme_paypal_url', array ('sandbox' => __('Paypal Sandbox (for testing)','events-made-easy'), 'live' => __( 'Paypal Live', 'events-made-easy')), __('Choose wether you want to test paypal in a paypal sandbox or go live and really use paypal.','events-made-easy') );
      ...
      echo "<tr><td colspan='2'>".__('Info: refunding not implemented yet.','events-made-easy').'</td></tr>';
   ?>
</table>
</div>

<h3><?php _e ( 'Legacy Paypal', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
      $notification_link = add_query_arg(array('eme_eventAction'=>'legacypaypal_notification'),$events_page_link);
      eme_options_select ( __('PayPal live or test','events-made-easy'), 'eme_legacypaypal_url', array ('sandbox' => __('Paypal Sandbox (for testing)','events-made-easy'), 'live' => __( 'Paypal Live', 'events-made-easy')), __('Choose wether you want to test paypal in a paypal sandbox or go live and really use paypal.','events-made-easy') );
      ...
      echo "<tr><td colspan='2'>".__('Info: refunding is possible.','events-made-easy').'</td></tr>';
   ?>
</table>
</div>


<h3><?php _e ( '2Checkout', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
<h3><?php _e ( 'Webmoney', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
<h3><?php _e ( 'First Data', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
      $notification_link = add_query_arg(array('eme_eventAction'=>'fdgg_notification'),$events_page_link);

      eme_options_select ( __('First Data live or test','events-made-easy'), 'eme_fdgg_url', array ('sandbox' => __('First Data Sandbox (for testing)','events-made-easy'), 'live' => __( 'First Data Live', 'events-made-easy')), __('Choose wether you want to test First Data in a sandbox or go live and really use First Data.','events-made-easy') );
...
<h3><?php _e ( 'Mollie', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
<h3><?php _e ( 'Payconiq', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
      $notification_link = add_query_arg(array('eme_eventAction'=>'payconiq_notification'),$events_page_link);
      eme_options_select ( __('Payconiq live or test','events-made-easy'), 'eme_payconiq_env', array ('sandbox' => __('Payconiq Sandbox (for testing)','events-made-easy'), 'production' => __( 'Payconiq Live', 'events-made-easy')), __('Choose wether you want to test Payconiq in a sandbox or go live and really use Payconiq.','events-made-easy') );
      ...
      eme_options_input_text (__('Text below payment button','events-made-easy'),'eme_'.$gateway.'_button_below', __('The text shown just below the payment button','events-made-easy').'<br />'.__('For all possible placeholders, see ', 'events-made-easy')."<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/payment-gateways/'>".__('the documentation', 'events-made-easy').'</a>');
      echo "<tr><td colspan='2'>".__('Info: the url for payment notifications is: ','events-made-easy').$notification_link.'</td></tr>';
      echo "<tr><td colspan='2'>".__('Info: refunding not implemented since it requires manual transfer of the funds to the relevant bank accounts anyway.','events-made-easy').'</td></tr>';
   ?>
</table>
</div>

<h3><?php _e ( 'Worldpay', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
<h3><?php _e ( 'Stripe', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
      ...
      eme_options_input_text (__('Text above payment button','events-made-easy'),'eme_'.$gateway.'_button_above', __('The text shown just above the payment button','events-made-easy').'<br />'.__('For all possible placeholders, see ', 'events-made-easy')."<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/payment-gateways/'>".__('the documentation', 'events-made-easy').'</a>');
      eme_options_input_text (__('Text below payment button','events-made-easy'),'eme_'.$gateway.'_button_below', __('The text shown just below the payment button','events-made-easy').'<br />'.__('For all possible placeholders, see ', 'events-made-easy')."<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/payment-gateways/'>".__('the documentation', 'events-made-easy').'</a>');
      $stripe_pms=array('alipay'=>'alipay','card'=>'card','ideal'=>'ideal','fpx'=>'fpx','bacs_debit'=>'bacs_debit','bancontact'=>'bancontact','giropay'=>'giropay','p24'=>'p24','eps'=>'eps','sofort'=>'sofort','sepa_debit'=>'sepa_debit','grabpay'=>'grabpay','afterpay_clearpay'=>'afterpay_clearpay','acss_debit'=>'acss_debit','wechat_pay'=>'wechat_pay','boleto'=>'boleto','oxxo'=>'oxxo');
      ...
      if (!empty($eme_stripe_private_key)) {
	      ...
	      if (empty($stripe_webhookid)) {
		      ...
		      if (!empty($err_txt))
			      ...
			      echo "<tr><td colspan='2' class='notice notice-warning'>".__('WARNING: no webhook has been created. Press save to attempt to create one.','events-made-easy').'</td></tr>';
	      } else {
		      echo "<tr><td colspan='2' class='notice notice-success'>".__('Info: a webhook to the mentioned link has been successfully created.','events-made-easy').'</td></tr>';
	      }
      }
   ?>
</table>
...
<h3><?php _e ( 'Braintree', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
<h3><?php _e ( 'Instamojo', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
      eme_options_select ( __('Instamojo live or test','events-made-easy'), 'eme_instamojo_env', array ('sandbox' => __('Instamojo Sandbox (for testing)','events-made-easy'), 'production' => __( 'Instamojo Live', 'events-made-easy')), __('Choose wether you want to test Instamojo in a sandbox or go live and really use Instamojo.','events-made-easy') );
...
<h3><?php _e ( 'Mercado Pago', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
      eme_options_select ( __('Mercado Pago live or test','events-made-easy'), 'eme_mercadopago_demo', array (1 => __('Mercado Pago Sandbox (for testing)','events-made-easy'), 0 => __( 'Mercado Pago Live', 'events-made-easy')), __('Choose wether you want to test Mercado Pago in a sandbox or go live and really use Mercado Pago.','events-made-easy') );
...
<h3><?php _e('Fondy', 'events-made-easy'); ?></h3>
<div>
<table class='form-table'>
   <?php
...
//   eme_options_radio_binary ( __ ( 'Unique email per person?', 'events-made-easy'), 'eme_unique_email_per_person', __ ( 'By default EME searches for a matching lastname-firstname-email combo when a person is entered in the database. If a match is found, that person is then updated. Using this option allows to search for just an email to find the matching person.', 'events-made-easy') );
   ...
   eme_options_radio_binary ( __( 'By default send out birthday email for new persons?', 'events-made-easy'), 'eme_bd_email', __( 'If selected, new persons registered with a non-empty birthday will get a birthday email. Go in the Mail Templates settings to change the look and feel of that email.', 'events-made-easy') ); 
...
<h3><?php _e ( 'Extra html tags', 'events-made-easy'); ?></h3>
<table class="form-table">
   <?php
