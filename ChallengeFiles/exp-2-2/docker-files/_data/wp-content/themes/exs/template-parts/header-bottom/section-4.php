...
<section id="header-bottom"
		class="header-bottom header-bottom-4 <?php echo esc_attr(  $exs_header_bottom_hidden_class . ' ' . $exs_header_bottom_background . ' ' . $exs_font_size . ' ' . $exs_background_image['class'] . $exs_extra_css_class ); ?>"
